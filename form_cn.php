...
<form method="post" action="./form_cn.php">
	<p>
		验证码图片：
		<img id="captcha_img" border="1" src="./captcha_cn.php?r=<?php echo rand();?>" width="200" height="60"/>
		<a href="javascript:void(0)" onclick="document.getElementById('captcha_img').src='./captcha_cn.php?r='+Math.random()" style="text-decoration:none;">换一个？</a>
	</p>
